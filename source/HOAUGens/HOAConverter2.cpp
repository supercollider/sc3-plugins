...
class mydsp : public dsp {
  ...
  public:
	...
	virtual int getInputRate (int i) 	{int rate[]={1,1,1,1,1,1,1,1,1}; return rate[i]; }
	virtual int getOutputRate(int i) 	{int rate[]={1,1,1,1,1,1,1,1,1}; return rate[i]; }
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalBargraph("0x7fbce6536ce0", &fbargraph0, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("1");
		interface->openVerticalBox("1");
		interface->declare(&fbargraph2, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce653aa10", &fbargraph2, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("2");
		interface->declare(&fbargraph3, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce653c1e0", &fbargraph3, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("3");
		interface->declare(&fbargraph4, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce653dca0", &fbargraph4, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("2");
		interface->openVerticalBox("4");
		interface->declare(&fbargraph8, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6545790", &fbargraph8, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("5");
		interface->declare(&fbargraph12, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce654c630", &fbargraph12, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("6");
		interface->declare(&fbargraph10, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6548bb0", &fbargraph10, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("7");
		interface->declare(&fbargraph13, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce654e250", &fbargraph13, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("8");
		interface->declare(&fbargraph9, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6546f90", &fbargraph9, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
		...
		interface->addVerticalBargraph("0x7fbce6538cd0", &fbargraph1, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("1");
		interface->openVerticalBox("1");
		interface->declare(&fbargraph5, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce653fad0", &fbargraph5, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("2");
		interface->declare(&fbargraph6, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6541b90", &fbargraph6, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("3");
		interface->declare(&fbargraph7, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6543920", &fbargraph7, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("2");
		interface->openVerticalBox("4");
		interface->declare(&fbargraph11, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce654a820", &fbargraph11, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("5");
		interface->declare(&fbargraph14, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6550320", &fbargraph14, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("6");
		interface->declare(&fbargraph15, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6552540", &fbargraph15, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("7");
		interface->declare(&fbargraph16, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6554620", &fbargraph16, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("8");
		interface->declare(&fbargraph17, "unit", "dB");
		interface->addVerticalBargraph("0x7fbce6556bf0", &fbargraph17, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
