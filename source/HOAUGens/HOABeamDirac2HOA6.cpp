...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow40 = (1.0 - (4.0 * ((1.0 - fSlow23) * fSlow15)));
		double fSlow41 = (0.0 - (2.0 * ((fSlow23 - fSlow40) * fSlow11)));
		double fSlow42 = mydsp_faustpower2_f(fSlow9);
		double fSlow43 = (fConst27 * ((fSlow41 * fSlow42) * fSlow12));
		double fSlow44 = ((893.67630033964599 * fSlow8) + -81.24330003087691);
		double fSlow45 = ((fSlow23 * fSlow44) * fSlow11);
		double fSlow46 = (fConst30 * ((fSlow45 * fSlow9) * fSlow12));
		double fSlow47 = ((3.6666666666666665 * (fSlow35 * fSlow8)) - (3.5 * fSlow26));
		double fSlow48 = (fSlow47 * fSlow11);
		double fSlow49 = (fConst32 * (fSlow48 * fSlow12));
		double fSlow50 = (fSlow16 * fSlow47);
		double fSlow51 = (fConst33 * fSlow50);
		double fSlow52 = (fSlow33 * fSlow44);
		double fSlow53 = (fConst34 * (fSlow52 * fSlow9));
		double fSlow54 = ((2.0 * fSlow33) - fSlow31);
		double fSlow55 = ((2.0 * ((fSlow32 + fSlow54) * fSlow15)) + -1.0);
		double fSlow56 = (fConst27 * (fSlow55 * fSlow42));
		double fSlow57 = pow(fSlow9, 2.5);
		double fSlow58 = (fConst35 * fSlow57);
		double fSlow59 = (fSlow40 * fSlow12);
		double fSlow60 = (fSlow54 * fSlow11);
		double fSlow61 = (fSlow40 * fSlow7);
		double fSlow62 = (fConst39 * (fSlow61 * fSlow12));
		double fSlow63 = (fSlow60 * fSlow7);
		double fSlow64 = (fConst39 * fSlow63);
		double fSlow65 = pow(fSlow9, 1.5);
		double fSlow66 = (fConst40 * fSlow65);
		double fSlow67 = (fSlow22 * fSlow12);
		double fSlow68 = (fSlow31 * fSlow11);
		double fSlow69 = (fSlow22 * fSlow7);
		double fSlow70 = (fConst44 * (fSlow69 * fSlow12));
		double fSlow71 = (fSlow68 * fSlow7);
		double fSlow72 = (fConst44 * fSlow71);
		double fSlow73 = ((284.35155010806915 * fSlow8) + -31.594616678674353);
		double fSlow74 = (fSlow22 * fSlow73);
		double fSlow75 = (fConst46 * (fSlow74 * fSlow12));
		double fSlow76 = ((fSlow31 * fSlow73) * fSlow11);
		double fSlow77 = (fConst46 * fSlow76);
		double fSlow78 = ((5.5 * fSlow73) + -252.75693342939482);
		double fSlow79 = ((fSlow22 * fSlow78) * fSlow7);
		double fSlow80 = (fConst49 * (fSlow79 * fSlow12));
		double fSlow81 = (((fSlow31 * fSlow78) * fSlow11) * fSlow7);
		double fSlow82 = (fConst49 * fSlow81);
		double fSlow83 = pow(fSlow9, 0.5);
		double fSlow84 = (fConst50 * fSlow83);
		double fSlow85 = (fConst54 * (fSlow7 * fSlow12));
		double fSlow86 = (fConst54 * fSlow18);
		double fSlow87 = ((16.925687506432688 * fSlow8) + -3.3851375012865379);
		double fSlow88 = (fConst56 * (fSlow87 * fSlow12));
		double fSlow89 = (fSlow87 * fSlow11);
		double fSlow90 = (fConst56 * fSlow89);
		double fSlow91 = ((3.5 * fSlow87) + -13.540550005146152);
		double fSlow92 = (fSlow91 * fSlow7);
		double fSlow93 = (fConst58 * (fSlow92 * fSlow12));
		double fSlow94 = ((fSlow91 * fSlow11) * fSlow7);
		double fSlow95 = (fConst58 * fSlow94);
		double fSlow96 = ((3.0 * (fSlow91 * fSlow8)) - (2.5 * fSlow87));
		double fSlow97 = (fConst60 * (fSlow96 * fSlow12));
		double fSlow98 = (fSlow96 * fSlow11);
		double fSlow99 = (fConst60 * fSlow98);
		double fSlow100 = ((2.75 * fSlow96) - (2.0 * fSlow91));
		double fSlow101 = (fSlow100 * fSlow7);
		double fSlow102 = (fConst62 * (fSlow101 * fSlow12));
		double fSlow103 = ((fSlow100 * fSlow11) * fSlow7);
		double fSlow104 = (fConst62 * fSlow103);
		double fSlow105 = ((3.0 * fSlow8) + -1.0);
		double fSlow106 = (1.1180339887498949 * fSlow105);
		double fSlow107 = ((2.5 * fSlow105) + -2.0);
		double fSlow108 = ((2.333333333333333 * (fSlow107 * fSlow8)) - (1.5 * fSlow105));
		double fSlow109 = (0.75 * fSlow108);
		double fSlow110 = (0.88191710368819687 * fSlow107);
		double fSlow111 = ((fSlow24 * fSlow42) * fSlow12);
		double fSlow112 = (fConst64 * fSlow111);
		double fSlow113 = ((2.25 * fSlow108) - (1.3333333333333333 * fSlow107));
		double fSlow114 = (0.66332495807108005 * fSlow113);
		double fSlow115 = (fSlow33 * fSlow42);
		double fSlow116 = (fConst65 * fSlow115);
		double fSlow117 = ((2.2000000000000002 * (fSlow113 * fSlow8)) - (1.25 * fSlow108));
		double fSlow118 = (0.60092521257733145 * fSlow117);
		double fSlow119 = (fConst66 * (fSlow83 * fSlow12));
		double fSlow120 = (0.13783222385544802 * fSlow7);
		double fSlow121 = (fConst66 * (fSlow11 * fSlow83));
		double fSlow122 = (fConst68 * ((fSlow11 * fSlow9) * fSlow12));
		double fSlow123 = (fConst69 * ((fSlow7 * fSlow83) * fSlow12));
		double fSlow124 = (0.088970317927147144 * fSlow105);
		double fSlow125 = (fConst69 * (fSlow18 * fSlow83));
		double fSlow126 = (fConst70 * (fSlow16 * fSlow9));
		double fSlow127 = (fConst71 * ((fSlow22 * fSlow65) * fSlow12));
		double fSlow128 = (fConst73 * ((fSlow18 * fSlow9) * fSlow12));
		double fSlow129 = (fConst74 * ((fSlow87 * fSlow83) * fSlow12));
		double fSlow130 = (0.070180733224632072 * (fSlow107 * fSlow7));
		double fSlow131 = (fConst74 * (fSlow89 * fSlow83));
		double fSlow132 = (fConst75 * (fSlow20 * fSlow9));
		double fSlow133 = (fConst71 * (fSlow68 * fSlow65));
		double fSlow134 = (fConst76 * fSlow111);
		double fSlow135 = (fConst77 * ((fSlow69 * fSlow65) * fSlow12));
		double fSlow136 = (fConst78 * ((fSlow27 * fSlow9) * fSlow12));
		double fSlow137 = (fConst79 * ((fSlow92 * fSlow83) * fSlow12));
		double fSlow138 = (0.059683103659460751 * fSlow108);
		double fSlow139 = (fConst79 * (fSlow94 * fSlow83));
		double fSlow140 = (fConst80 * (fSlow29 * fSlow9));
		double fSlow141 = (fConst77 * (fSlow71 * fSlow65));
		double fSlow142 = (fConst81 * fSlow115);
		double fSlow143 = (fConst82 * ((fSlow40 * fSlow57) * fSlow12));
		double fSlow144 = (fConst83 * (((fSlow24 * fSlow7) * fSlow42) * fSlow12));
		double fSlow145 = (fConst84 * ((fSlow74 * fSlow65) * fSlow12));
		double fSlow146 = (fConst85 * ((fSlow36 * fSlow9) * fSlow12));
		double fSlow147 = (fConst86 * ((fSlow96 * fSlow83) * fSlow12));
		double fSlow148 = (0.052785722976618307 * (fSlow113 * fSlow7));
		double fSlow149 = (fConst86 * (fSlow98 * fSlow83));
		double fSlow150 = (fConst87 * (fSlow38 * fSlow9));
		double fSlow151 = (fConst84 * (fSlow76 * fSlow65));
		double fSlow152 = (fConst88 * ((fSlow33 * fSlow7) * fSlow42));
		double fSlow153 = (fConst82 * (fSlow60 * fSlow57));
		double fSlow154 = mydsp_faustpower3_f(fSlow9);
		double fSlow155 = (fConst89 * ((fSlow41 * fSlow154) * fSlow12));
		double fSlow156 = (fConst90 * ((fSlow61 * fSlow57) * fSlow12));
		double fSlow157 = (fConst91 * ((fSlow45 * fSlow42) * fSlow12));
		double fSlow158 = (fConst92 * ((fSlow79 * fSlow65) * fSlow12));
		double fSlow159 = (fConst93 * ((fSlow48 * fSlow9) * fSlow12));
		double fSlow160 = (fConst94 * ((fSlow101 * fSlow83) * fSlow12));
		double fSlow161 = (0.047820109005115151 * fSlow117);
		double fSlow162 = (fConst94 * (fSlow103 * fSlow83));
		double fSlow163 = (fConst95 * (fSlow50 * fSlow9));
		double fSlow164 = (fConst92 * (fSlow81 * fSlow65));
		double fSlow165 = (fConst96 * (fSlow52 * fSlow42));
		double fSlow166 = (fConst90 * (fSlow63 * fSlow57));
		double fSlow167 = (fConst89 * (fSlow55 * fSlow154));
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			double fTemp51 = ((fSlow9 * (((((((((((((fConst2 * (((fConst5 * ((fSlow13 * (iSlow1?(fSlow3 * (fTemp3 * fTemp2)):(fSlow3 * (fTemp1 * fTemp2)))) + (fSlow17 * (iSlow1?(fSlow3 * (fTemp3 * fTemp4)):(fSlow3 * (fTemp1 * fTemp4)))))) + (fSlow19 * (iSlow1?(fSlow3 * (fTemp3 * fTemp5)):(fSlow3 * (fTemp1 * fTemp5))))) + (fSlow21 * (iSlow1?(fSlow3 * (fTemp3 * fTemp6)):(fSlow3 * (fTemp1 * fTemp6)))))) + (fSlow25 * (iSlow1?(fSlow3 * (fTemp3 * fTemp7)):(fSlow3 * (fTemp1 * fTemp7))))) + (fSlow28 * (iSlow1?(fSlow3 * (fTemp3 * fTemp8)):(fSlow3 * (fTemp1 * fTemp8))))) + (fSlow30 * (iSlow1?(fSlow3 * (fTemp3 * fTemp9)):(fSlow3 * (fTemp1 * fTemp9))))) + (fSlow34 * (iSlow1?(fSlow3 * (fTemp3 * fTemp10)):(fSlow3 * (fTemp1 * fTemp10))))) + (fSlow37 * (iSlow1?(fSlow3 * (fTemp3 * fTemp11)):(fSlow3 * (fTemp1 * fTemp11))))) + (fSlow39 * (iSlow1?(fSlow3 * (fTemp3 * fTemp12)):(fSlow3 * (fTemp1 * fTemp12))))) + (fSlow43 * (iSlow1?(fSlow3 * (fTemp3 * fTemp13)):(fSlow3 * (fTemp1 * fTemp13))))) + (fSlow46 * (iSlow1?(fSlow3 * (fTemp3 * fTemp14)):(fSlow3 * (fTemp1 * fTemp14))))) + (fSlow49 * (iSlow1?(fSlow3 * (fTemp3 * fTemp15)):(fSlow3 * (fTemp1 * fTemp15))))) + (fSlow51 * (iSlow1?(fSlow3 * (fTemp3 * fTemp16)):(fSlow3 * (fTemp1 * fTemp16))))) + (fSlow53 * (iSlow1?(fSlow3 * (fTemp3 * fTemp17)):(fSlow3 * (fTemp1 * fTemp17))))) + (fSlow56 * (iSlow1?(fSlow3 * (fTemp3 * fTemp18)):(fSlow3 * (fTemp1 * fTemp18)))))) + ((fSlow58 * (((fConst37 * ((fSlow59 * (iSlow1?(fSlow3 * (fTemp3 * fTemp19)):(fSlow3 * (fTemp1 * fTemp19)))) + (fSlow60 * (iSlow1?(fSlow3 * (fTemp3 * fTemp20)):(fSlow3 * (fTemp1 * fTemp20)))))) + (fSlow62 * (iSlow1?(fSlow3 * (fTemp3 * fTemp21)):(fSlow3 * (fTemp1 * fTemp21))))) + (fSlow64 * (iSlow1?(fSlow3 * (fTemp3 * fTemp22)):(fSlow3 * (fTemp1 * fTemp22)))))) + ((fSlow66 * (((((((fConst42 * ((fSlow67 * (iSlow1?(fSlow3 * (fTemp3 * fTemp23)):(fSlow3 * (fTemp1 * fTemp23)))) + (fSlow68 * (iSlow1?(fSlow3 * (fTemp3 * fTemp24)):(fSlow3 * (fTemp1 * fTemp24)))))) + (fSlow70 * (iSlow1?(fSlow3 * (fTemp3 * fTemp25)):(fSlow3 * (fTemp1 * fTemp25))))) + (fSlow72 * (iSlow1?(fSlow3 * (fTemp3 * fTemp26)):(fSlow3 * (fTemp1 * fTemp26))))) + (fSlow75 * (iSlow1?(fSlow3 * (fTemp3 * fTemp27)):(fSlow3 * (fTemp1 * fTemp27))))) + (fSlow77 * (iSlow1?(fSlow3 * (fTemp3 * fTemp28)):(fSlow3 * (fTemp1 * fTemp28))))) + (fSlow80 * (iSlow1?(fSlow3 * (fTemp3 * fTemp29)):(fSlow3 * (fTemp1 * fTemp29))))) + (fSlow82 * (iSlow1?(fSlow3 * (fTemp3 * fTemp30)):(fSlow3 * (fTemp1 * fTemp30)))))) + ((fSlow84 * (((((((((((fConst52 * ((fSlow12 * (iSlow1?(fSlow3 * (fTemp3 * fTemp31)):(fSlow3 * (fTemp1 * fTemp31)))) + (fSlow11 * (iSlow1?(fSlow3 * (fTemp3 * fTemp32)):(fSlow3 * (fTemp1 * fTemp32)))))) + (fSlow85 * (iSlow1?(fSlow3 * (fTemp3 * fTemp33)):(fSlow3 * (fTemp1 * fTemp33))))) + (fSlow86 * (iSlow1?(fSlow3 * (fTemp3 * fTemp34)):(fSlow3 * (fTemp1 * fTemp34))))) + (fSlow88 * (iSlow1?(fSlow3 * (fTemp3 * fTemp35)):(fSlow3 * (fTemp1 * fTemp35))))) + (fSlow90 * (iSlow1?(fSlow3 * (fTemp3 * fTemp36)):(fSlow3 * (fTemp1 * fTemp36))))) + (fSlow93 * (iSlow1?(fSlow3 * (fTemp3 * fTemp37)):(fSlow3 * (fTemp1 * fTemp37))))) + (fSlow95 * (iSlow1?(fSlow3 * (fTemp3 * fTemp38)):(fSlow3 * (fTemp1 * fTemp38))))) + (fSlow97 * (iSlow1?(fSlow3 * (fTemp3 * fTemp39)):(fSlow3 * (fTemp1 * fTemp39))))) + (fSlow99 * (iSlow1?(fSlow3 * (fTemp3 * fTemp40)):(fSlow3 * (fTemp1 * fTemp40))))) + (fSlow102 * (iSlow1?(fSlow3 * (fTemp3 * fTemp41)):(fSlow3 * (fTemp1 * fTemp41))))) + (fSlow104 * (iSlow1?(fSlow3 * (fTemp3 * fTemp42)):(fSlow3 * (fTemp1 * fTemp42)))))) + (((((iSlow1?(fSlow3 * (fTemp3 * fTemp0)):(fSlow3 * (fTemp1 * fTemp0))) + (fSlow106 * (iSlow1?(fSlow3 * (fTemp3 * fTemp43)):(fSlow3 * (fTemp1 * fTemp43))))) + (fSlow109 * (iSlow1?(fSlow3 * (fTemp3 * fTemp44)):(fSlow3 * (fTemp1 * fTemp44))))) + (fSlow7 * (((((1.7320508075688772 * (iSlow1?(fSlow3 * (fTemp3 * fTemp45)):(fSlow3 * (fTemp1 * fTemp45)))) + (fSlow110 * (iSlow1?(fSlow3 * (fTemp3 * fTemp46)):(fSlow3 * (fTemp1 * fTemp46))))) + (fSlow112 * (iSlow1?(fSlow3 * (fTemp3 * fTemp47)):(fSlow3 * (fTemp1 * fTemp47))))) + (fSlow114 * (iSlow1?(fSlow3 * (fTemp3 * fTemp48)):(fSlow3 * (fTemp1 * fTemp48))))) + (fSlow116 * (iSlow1?(fSlow3 * (fTemp3 * fTemp49)):(fSlow3 * (fTemp1 * fTemp49))))))) + (fSlow118 * (iSlow1?(fSlow3 * (fTemp3 * fTemp50)):(fSlow3 * (fTemp1 * fTemp50)))))))));
			output0[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp0)):(fSlow3 * (fRec0[0] * fTemp0))) + (0.079577471545947673 * fTemp51)));
			output1[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp31)):(fSlow3 * (fRec0[0] * fTemp31))) + (fSlow119 * fTemp51)));
			output2[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp45)):(fSlow3 * (fRec0[0] * fTemp45))) + (fSlow120 * fTemp51)));
			output3[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp32)):(fSlow3 * (fRec0[0] * fTemp32))) + (fSlow121 * fTemp51)));
			output4[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp2)):(fSlow3 * (fRec0[0] * fTemp2))) + (fSlow122 * fTemp51)));
			output5[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp33)):(fSlow3 * (fRec0[0] * fTemp33))) + (fSlow123 * fTemp51)));
			output6[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp43)):(fSlow3 * (fRec0[0] * fTemp43))) + (fSlow124 * fTemp51)));
			output7[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp34)):(fSlow3 * (fRec0[0] * fTemp34))) + (fSlow125 * fTemp51)));
			output8[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp4)):(fSlow3 * (fRec0[0] * fTemp4))) + (fSlow126 * fTemp51)));
			output9[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp23)):(fSlow3 * (fRec0[0] * fTemp23))) + (fSlow127 * fTemp51)));
			output10[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp5)):(fSlow3 * (fRec0[0] * fTemp5))) + (fSlow128 * fTemp51)));
			output11[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp35)):(fSlow3 * (fRec0[0] * fTemp35))) + (fSlow129 * fTemp51)));
			output12[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp46)):(fSlow3 * (fRec0[0] * fTemp46))) + (fSlow130 * fTemp51)));
			output13[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp36)):(fSlow3 * (fRec0[0] * fTemp36))) + (fSlow131 * fTemp51)));
			output14[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp6)):(fSlow3 * (fRec0[0] * fTemp6))) + (fSlow132 * fTemp51)));
			output15[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp24)):(fSlow3 * (fRec0[0] * fTemp24))) + (fSlow133 * fTemp51)));
			output16[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp7)):(fSlow3 * (fRec0[0] * fTemp7))) + (fSlow134 * fTemp51)));
			output17[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp25)):(fSlow3 * (fRec0[0] * fTemp25))) + (fSlow135 * fTemp51)));
			output18[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp8)):(fSlow3 * (fRec0[0] * fTemp8))) + (fSlow136 * fTemp51)));
			output19[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp37)):(fSlow3 * (fRec0[0] * fTemp37))) + (fSlow137 * fTemp51)));
			output20[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp44)):(fSlow3 * (fRec0[0] * fTemp44))) + (fSlow138 * fTemp51)));
			output21[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp38)):(fSlow3 * (fRec0[0] * fTemp38))) + (fSlow139 * fTemp51)));
			output22[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp9)):(fSlow3 * (fRec0[0] * fTemp9))) + (fSlow140 * fTemp51)));
			output23[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp26)):(fSlow3 * (fRec0[0] * fTemp26))) + (fSlow141 * fTemp51)));
			output24[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp10)):(fSlow3 * (fRec0[0] * fTemp10))) + (fSlow142 * fTemp51)));
			output25[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp19)):(fSlow3 * (fRec0[0] * fTemp19))) + (fSlow143 * fTemp51)));
			output26[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp47)):(fSlow3 * (fRec0[0] * fTemp47))) + (fSlow144 * fTemp51)));
			output27[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp27)):(fSlow3 * (fRec0[0] * fTemp27))) + (fSlow145 * fTemp51)));
			output28[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp11)):(fSlow3 * (fRec0[0] * fTemp11))) + (fSlow146 * fTemp51)));
			output29[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp39)):(fSlow3 * (fRec0[0] * fTemp39))) + (fSlow147 * fTemp51)));
			output30[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp48)):(fSlow3 * (fRec0[0] * fTemp48))) + (fSlow148 * fTemp51)));
			output31[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp40)):(fSlow3 * (fRec0[0] * fTemp40))) + (fSlow149 * fTemp51)));
			output32[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp12)):(fSlow3 * (fRec0[0] * fTemp12))) + (fSlow150 * fTemp51)));
			output33[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp28)):(fSlow3 * (fRec0[0] * fTemp28))) + (fSlow151 * fTemp51)));
			output34[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp49)):(fSlow3 * (fRec0[0] * fTemp49))) + (fSlow152 * fTemp51)));
			output35[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp20)):(fSlow3 * (fRec0[0] * fTemp20))) + (fSlow153 * fTemp51)));
			output36[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp13)):(fSlow3 * (fRec0[0] * fTemp13))) + (fSlow155 * fTemp51)));
			output37[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp21)):(fSlow3 * (fRec0[0] * fTemp21))) + (fSlow156 * fTemp51)));
			output38[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp14)):(fSlow3 * (fRec0[0] * fTemp14))) + (fSlow157 * fTemp51)));
			output39[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp29)):(fSlow3 * (fRec0[0] * fTemp29))) + (fSlow158 * fTemp51)));
			output40[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp15)):(fSlow3 * (fRec0[0] * fTemp15))) + (fSlow159 * fTemp51)));
			output41[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp41)):(fSlow3 * (fRec0[0] * fTemp41))) + (fSlow160 * fTemp51)));
			output42[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp50)):(fSlow3 * (fRec0[0] * fTemp50))) + (fSlow161 * fTemp51)));
			output43[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp42)):(fSlow3 * (fRec0[0] * fTemp42))) + (fSlow162 * fTemp51)));
			output44[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp16)):(fSlow3 * (fRec0[0] * fTemp16))) + (fSlow163 * fTemp51)));
			output45[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp30)):(fSlow3 * (fRec0[0] * fTemp30))) + (fSlow164 * fTemp51)));
			output46[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp17)):(fSlow3 * (fRec0[0] * fTemp17))) + (fSlow165 * fTemp51)));
			output47[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp22)):(fSlow3 * (fRec0[0] * fTemp22))) + (fSlow166 * fTemp51)));
			output48[i] = FAUSTFLOAT(((iSlow1?(fSlow3 * (fRec1[0] * fTemp18)):(fSlow3 * (fRec0[0] * fTemp18))) + (fSlow167 * fTemp51)));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
