...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalBargraph("0x7fd2b92b4ec0", &fbargraph30, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fbargraph31, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92b62e0", &fbargraph31, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fbargraph29, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92b3aa0", &fbargraph29, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fbargraph28, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92b2680", &fbargraph28, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fbargraph27, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92b1260", &fbargraph27, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fbargraph26, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92afe40", &fbargraph26, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("7");
		ui_interface->declare(&fbargraph25, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92aea20", &fbargraph25, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("8");
		ui_interface->declare(&fbargraph24, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92ad600", &fbargraph24, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("9");
		ui_interface->declare(&fbargraph23, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92ac1e0", &fbargraph23, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("10");
		ui_interface->declare(&fbargraph22, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92aadc0", &fbargraph22, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("11");
		ui_interface->declare(&fbargraph21, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a99a0", &fbargraph21, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("12");
		ui_interface->declare(&fbargraph20, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a8580", &fbargraph20, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("13");
		ui_interface->declare(&fbargraph19, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a7160", &fbargraph19, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("14");
		ui_interface->declare(&fbargraph18, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a5d40", &fbargraph18, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("15");
		ui_interface->declare(&fbargraph17, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a4920", &fbargraph17, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("16");
		ui_interface->declare(&fbargraph16, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a3500", &fbargraph16, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("17");
		ui_interface->declare(&fbargraph15, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a20e0", &fbargraph15, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("18");
		ui_interface->declare(&fbargraph14, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92a0cc0", &fbargraph14, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("19");
		ui_interface->declare(&fbargraph13, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b929f8a0", &fbargraph13, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("20");
		ui_interface->declare(&fbargraph12, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b929e480", &fbargraph12, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("21");
		ui_interface->declare(&fbargraph11, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b929d060", &fbargraph11, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("22");
		ui_interface->declare(&fbargraph10, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b929bc40", &fbargraph10, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("23");
		ui_interface->declare(&fbargraph9, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b929a820", &fbargraph9, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("24");
		ui_interface->declare(&fbargraph8, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9299400", &fbargraph8, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("25");
		ui_interface->declare(&fbargraph7, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9298000", &fbargraph7, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("26");
		ui_interface->declare(&fbargraph6, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9296c10", &fbargraph6, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("27");
		ui_interface->declare(&fbargraph5, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9295820", &fbargraph5, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("28");
		ui_interface->declare(&fbargraph4, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9294440", &fbargraph4, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("29");
		ui_interface->declare(&fbargraph3, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92930d0", &fbargraph3, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("30");
		ui_interface->declare(&fbargraph2, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b9291d60", &fbargraph2, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("31");
		ui_interface->declare(&fbargraph1, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92909f0", &fbargraph1, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("32");
		ui_interface->declare(&fbargraph0, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b928f5e0", &fbargraph0, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addVerticalBargraph("0x7fd2b92ba660", &fbargraph32, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("1");
		ui_interface->openVerticalBox("1");
		ui_interface->declare(&fbargraph33, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92bf930", &fbargraph33, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("2");
		ui_interface->declare(&fbargraph34, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92c2f30", &fbargraph34, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("3");
		ui_interface->declare(&fbargraph35, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92c8940", &fbargraph35, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("2");
		ui_interface->openVerticalBox("4");
		ui_interface->declare(&fbargraph36, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92cd2f0", &fbargraph36, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("5");
		ui_interface->declare(&fbargraph37, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92d0900", &fbargraph37, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("6");
		ui_interface->declare(&fbargraph38, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92d4420", &fbargraph38, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("7");
		ui_interface->declare(&fbargraph39, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92d7d50", &fbargraph39, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("8");
		ui_interface->declare(&fbargraph40, "unit", "dB");
		ui_interface->addVerticalBargraph("0x7fd2b92dc8b0", &fbargraph40, -7e+01, 6.0);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			double fTemp72 = (fTemp39 + fTemp33);
			double fTemp73 = (fRec1[0] * ((((0.031249999999425383 * fTemp65) + ((((0.02845603116607446 * fTemp63) + (0.05056356215458725 * fTemp51)) + (0.02845603115179167 * fTemp25)) + (0.050563562146664694 * fTemp11))) + (0.03125000000535643 * fTemp66)) - (((((0.03124999999974435 * fTemp67) + ((2.0741519909290582e-11 * fTemp68) + ((0.03124999999253746 * fTemp69) + ((((0.028456031178947395 * fTemp57) + (0.050563562158055714 * fTemp43)) + (0.028456031143523002 * fTemp29)) + (0.05056356214319625 * fTemp19))))) + (1.167285910621688e-11 * fTemp70)) + (0.04604282561133058 * (fTemp3 + (fTemp5 - fTemp71)))) + (0.01931356213232534 * (fTemp1 + (fTemp7 - fTemp72))))));
			fRec34[0] = max((fRec34[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp73))))));
			fbargraph33 = fRec34[0];
			output1[i] = (FAUSTFLOAT)fTemp73;
			double fTemp74 = (fTemp53 - fTemp49);
			double fTemp75 = (fTemp37 - fTemp35);
			double fTemp76 = (fTemp61 - fTemp59);
			double fTemp77 = (fTemp55 - fTemp47);
			double fTemp78 = (fTemp39 - fTemp33);
			double fTemp79 = (fRec1[0] * ((0.0312500000013087 * (fTemp9 - (fTemp13 + (fTemp17 - (fTemp21 + (fTemp41 - (fTemp45 - fTemp74))))))) - (((0.02845603116607446 * (fTemp3 - (fTemp5 + fTemp75))) + ((0.019313562147752456 * (fTemp27 - (fTemp31 + fTemp76))) + (0.0460428256143214 * (fTemp15 - (fTemp23 + fTemp77))))) + (0.05056356215458725 * (fTemp1 - (fTemp7 + fTemp78))))));
			fRec35[0] = max((fRec35[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp79))))));
			fbargraph34 = fRec35[0];
			output2[i] = (FAUSTFLOAT)fTemp79;
			double fTemp80 = (fTemp55 + fTemp47);
			double fTemp81 = (fTemp61 + fTemp59);
			double fTemp82 = (fTemp5 + fTemp3);
			double fTemp83 = (fTemp7 + fTemp1);
			double fTemp84 = (fRec1[0] * ((((0.031249999999265907 * fTemp65) + ((0.019313562123244806 * fTemp43) + (((0.04604282561133058 * fTemp63) + (0.046042825603374665 * fTemp57)) + (0.01931356213232534 * fTemp51)))) + (0.031250000006153834 * fTemp69)) - ((((0.028456031161235202 * (fTemp15 + (fTemp23 - fTemp80))) + ((0.05056356214869462 * (fTemp27 + (fTemp31 - fTemp81))) + (((0.031249999998946943 * fTemp67) + ((3.961277810183797e-12 * fTemp72) + ((9.4435413914174e-12 * fTemp71) + (((0.019313562162147378 * fTemp19) + ((0.04604282562526814 * fTemp29) + (0.04604282562015782 * fTemp25))) + (0.01931356215306686 * fTemp11))))) + (0.03124999999333487 * fTemp66)))) + (1.771220524667885e-11 * fTemp82)) + (7.429730299785245e-12 * fTemp83))));
			fRec36[0] = max((fRec36[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp84))))));
			fbargraph35 = fRec36[0];
			output3[i] = (FAUSTFLOAT)fTemp84;
			double fTemp85 = (fRec1[0] * ((((((4.3326398788419054e-11 * fTemp68) + ((((0.05412658773668735 * fTemp63) + (0.04034357649425392 * fTemp51)) + (0.054126587710176526 * fTemp29)) + (0.04034357654745972 * fTemp19))) + (1.3722268867176347e-11 * fTemp70)) + (3.3690616435560736e-11 * fTemp82)) + (5.928021680210456e-12 * fTemp83)) - (((3.160618191051283e-12 * fTemp72) + ((1.796268315438824e-11 * fTemp71) + ((((0.054126587751820394 * fTemp57) + (0.04034357647805324 * fTemp43)) + (0.05412658771989692 * fTemp25)) + (0.040343576531259084 * fTemp11)))) + (0.040343576521304395 * (fTemp9 + (fTemp13 - (fTemp17 + (fTemp21 - (fTemp41 + (fTemp45 - fTemp65))))))))));
			fRec37[0] = max((fRec37[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp85))))));
			fbargraph36 = fRec37[0];
			output4[i] = (FAUSTFLOAT)fTemp85;
			double fTemp86 = (fTemp45 - fTemp41);
			double fTemp87 = (fTemp21 - fTemp17);
			double fTemp88 = (fTemp13 - fTemp9);
			double fTemp89 = (fRec1[0] * (((((0.04034357652394163 * fTemp74) + (0.040343576515049356 * fTemp86)) + (0.05412658773668735 * (fTemp3 - (fTemp5 - fTemp75)))) + (0.04034357649425392 * (fTemp1 - (fTemp7 - fTemp78)))) - ((((1.654921172637441e-11 * (fTemp31 - fTemp27)) + (0.040343576524353414 * fTemp87)) + (2.2203097434927284e-11 * (fTemp23 - fTemp15))) + (0.04034357653159858 * fTemp88))));
			fRec38[0] = max((fRec38[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp89))))));
			fbargraph37 = fRec38[0];
			output5[i] = (FAUSTFLOAT)fTemp89;
			double fTemp90 = (fTemp15 + (fTemp23 + fTemp80));
			double fTemp91 = (fTemp1 + (fTemp7 + fTemp72));
			double fTemp92 = (fTemp27 + (fTemp31 + fTemp81));
			double fTemp93 = (fTemp3 + (fTemp5 + fTemp71));
			double fTemp94 = (fRec1[0] * ((((0.04090678108379355 * fTemp90) + (2.926356954413283e-12 * (fTemp9 + (fTemp13 + (fTemp17 + (fTemp21 + (fTemp41 + (fTemp45 + fTemp65)))))))) + (0.05653178109647902 * fTemp91)) - (((0.02159321892672506 * fTemp92) + (0.034938562148434216 * (fTemp11 + (fTemp19 + (fTemp25 + (fTemp29 + (fTemp43 + (fTemp51 + (fTemp63 + fTemp57))))))))) + (0.005968218925505893 * fTemp93))));
			fRec39[0] = max((fRec39[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp94))))));
			fbargraph38 = fRec39[0];
			output6[i] = (FAUSTFLOAT)fTemp94;
			double fTemp95 = (fRec1[0] * (((0.05412658773099845 * (fTemp15 - (fTemp23 - fTemp77))) + ((0.0403435765217776 * (fTemp27 - (fTemp31 - fTemp76))) + ((0.04034357652373575 * fTemp74) + (0.04034357651607881 * fTemp88)))) - (((((0.040343576532628024 * fTemp86) + ((1.1101548718630453e-11 * fTemp75) + (8.274605857542004e-12 * fTemp78))) + (0.04034357652332397 * fTemp87)) + (2.0821946059249937e-11 * (fTemp5 - fTemp3))) + (1.5519762259670396e-11 * (fTemp7 - fTemp1)))));
			fRec40[0] = max((fRec40[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp95))))));
			fbargraph39 = fRec40[0];
			output7[i] = (FAUSTFLOAT)fTemp95;
			double fTemp96 = (fRec1[0] * ((((0.052810427283009165 * fTemp92) + ((1.7578661182284158e-11 * fTemp69) + ((((0.027063293867943854 * fTemp63) + (0.027063293837677766 * fTemp57)) + (0.027063293920965504 * fTemp29)) + (0.027063293901524708 * fTemp25)))) + (0.016726035452584633 * fTemp90)) - (((0.043789329326217374 * fTemp93) + ((1.5519762270076438e-11 * fTemp66) + ((1.0294494561038593e-12 * fTemp67) + ((2.0588989122077187e-13 * fTemp65) + ((0.04510548977304693 * fTemp11) + (((0.04510548980614536 * fTemp51) + (0.04510548982063568 * fTemp43)) + (0.04510548975855663 * fTemp19))))))) + (0.007704937489172767 * fTemp91))));
			fRec41[0] = max((fRec41[1] - fConst0), min((double)6, (20 * log10(max(0.00031622776601683794, fabs(fTemp96))))));
			fbargraph40 = fRec41[0];
			output8[i] = (FAUSTFLOAT)fTemp96;
			// post processing
			fRec41[1] = fRec41[0];
			fRec40[1] = fRec40[0];
			fRec39[1] = fRec39[0];
