...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("HOAAzimuthRotator4");
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fTempPerm2 = (double)input8[i];
			fTempPerm3 = (double)input4[i];
			output4[i] = (FAUSTFLOAT)((fSlow7 * fTempPerm2) + (fSlow8 * fTempPerm3));
			fTempPerm4 = (double)input7[i];
			fTempPerm5 = (double)input5[i];
			output5[i] = (FAUSTFLOAT)((fSlow2 * fTempPerm4) + (fSlow1 * fTempPerm5));
			output6[i] = (FAUSTFLOAT)(double)input6[i];
			output7[i] = (FAUSTFLOAT)((fSlow4 * fTempPerm5) + (fSlow5 * fTempPerm4));
			output8[i] = (FAUSTFLOAT)((fSlow10 * fTempPerm3) + (fSlow11 * fTempPerm2));
			...
			output10[i] = (FAUSTFLOAT)((fSlow8 * fTempPerm8) + (fSlow7 * fTempPerm9));
			...
			output18[i] = (FAUSTFLOAT)((fSlow8 * fTempPerm16) + (fSlow7 * fTempPerm17));
