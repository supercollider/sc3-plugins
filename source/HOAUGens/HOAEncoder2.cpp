...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalBargraph("0x7f9614162bc0", &fbargraph0, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("1");
		interface->openVerticalBox("1");
		interface->declare(&fbargraph1, "unit", "dB");
		interface->addVerticalBargraph("0x7f9614168100", &fbargraph1, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("2");
		interface->declare(&fbargraph2, "unit", "dB");
		interface->addVerticalBargraph("0x7f9614169b50", &fbargraph2, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("3");
		interface->declare(&fbargraph3, "unit", "dB");
		interface->addVerticalBargraph("0x7f961416b7b0", &fbargraph3, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("2");
		interface->openVerticalBox("4");
		interface->declare(&fbargraph4, "unit", "dB");
		interface->addVerticalBargraph("0x7f9614171730", &fbargraph4, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("5");
		interface->declare(&fbargraph5, "unit", "dB");
		interface->addVerticalBargraph("0x7f96141733f0", &fbargraph5, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("6");
		interface->declare(&fbargraph6, "unit", "dB");
		interface->addVerticalBargraph("0x7f96141751a0", &fbargraph6, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("7");
		interface->declare(&fbargraph7, "unit", "dB");
		interface->addVerticalBargraph("0x7f9614176dc0", &fbargraph7, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("8");
		interface->declare(&fbargraph8, "unit", "dB");
		interface->addVerticalBargraph("0x7f9614178b90", &fbargraph8, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow25 = (1.9364916731037085 * (fSlow23 * sin(fSlow24)));
		double 	fSlow26 = faustpower<2>(fSlow12);
		double 	fSlow27 = (1 + ((fConst4 / fSlow4) + (3 * fSlow26)));
		double 	fSlow28 = (1.0 / fSlow27);
		double 	fSlow29 = (12 * fSlow26);
		double 	fSlow30 = (fSlow29 + (fConst5 / fSlow4));
		double 	fSlow31 = faustpower<2>(fSlow15);
		double 	fSlow32 = (1.0 / (1 + ((fConst4 / fSlow2) + (3 * fSlow31))));
		double 	fSlow33 = ((fSlow3 * fSlow27) / fSlow4);
		double 	fSlow34 = (12 * fSlow31);
		double 	fSlow35 = (fSlow34 + (fConst5 / fSlow2));
		double fTemp7;
		double fTemp8;
		double fTemp9;
		double 	fSlow36 = sin((2 * fSlow7));
		double 	fSlow37 = (1.9364916731037085 * (fSlow36 * fSlow10));
		double fTemp10;
		double 	fSlow38 = (1.118033988749895 * ((3 * faustpower<2>(fSlow19)) - 1));
		double fTemp11;
		double 	fSlow39 = (1.9364916731037085 * (fSlow36 * fSlow21));
		double fTemp12;
		double 	fSlow40 = (1.9364916731037085 * (fSlow23 * cos(fSlow24)));
		double fTemp13;
