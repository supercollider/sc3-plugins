...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalBargraph("0x7f96c7f697d0", &fbargraph0, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->openHorizontalBox("1");
		interface->openVerticalBox("1");
		interface->declare(&fbargraph1, "unit", "dB");
		interface->addVerticalBargraph("0x7f96c7f6eb00", &fbargraph1, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("2");
		interface->declare(&fbargraph2, "unit", "dB");
		interface->addVerticalBargraph("0x7f96c7f704c0", &fbargraph2, -7e+01, 6.0);
		interface->closeBox();
		interface->openVerticalBox("3");
		interface->declare(&fbargraph3, "unit", "dB");
		interface->addVerticalBargraph("0x7f96c7f72120", &fbargraph3, -7e+01, 6.0);
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
		interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow11 = (1 + (fConst3 / fSlow4));
		double 	fSlow12 = (fConst2 / (fSlow4 * fSlow11));
		double 	fSlow13 = (1.0 / (1 + (fConst3 / fSlow2)));
		...
		for (int i=0; i<count; i++) {
			...
			fTemp2 = ((fSlow12 * (fRec3[0] - fRec4[0])) + (fRec4[0] + (fSlow1 * fTemp0)));
