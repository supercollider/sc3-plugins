...
.readonlinelink {font-size: smaller;}
...
<p style="padding: 10px; text-align: center; border: 1px solid blue; width: 50%;"><a href="http://sourceforge.net/project/platformdownload.php?group_id=182627">Download the plugins</a></p>
	...
	<ul class="grouplist">
		...
		foreach($grlist as $item){
			...
			<li><?php
				echo $item['name'];
				if(isset($item['fpath']))
					echo " [<a class='readonlinelink' href='http://sc3-plugins.svn.sourceforge.net/viewvc/sc3-plugins/build/$item[fpath]'>read online</a>]";
			?></li>
			<?php
		}
		?>
